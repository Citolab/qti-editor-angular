...
class SlashMenuItemElement extends LitElement {
  ...
  render() {
    return html`<prosekit-autocomplete-item
      ...
      class="relative flex items-center justify-between min-w-32 scroll-my-1 rounded-sm px-3 py-1.5 box-border cursor-default select-none whitespace-nowrap outline-hidden data-highlighted:bg-gray-100 dark:data-highlighted:bg-gray-800 ${this.disabled ? 'opacity-50 pointer-events-none' : ''}"
    >
